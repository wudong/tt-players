...
const PWAInstallSheet: React.FC = () => {
  const { showAndroidSheet, showIosSheet, install, dismiss } = usePWAInstall();
  ...
  return (
    <>
      {/* Backdrop */}
      <div 
        className={`menu-hider ${showAndroidSheet || showIosSheet ? 'menu-active' : ''}`} 
        onClick={dismiss}
        style={{ zIndex: 998 }}
      ></div>
      ...
      <div 
        ...
        className={`menu menu-box-bottom rounded-m ${showAndroidSheet ? 'menu-active' : ''}`}
      ...
      >
        <div className="content">
          ...
          <p className="text-center boxed-text-xl">
            Install TT Players on your home screen, and access it just like a regular app. It really is that simple!
          </p>
      ...
      <div 
        ...
        className={`menu menu-box-bottom rounded-m ${showIosSheet ? 'menu-active' : ''}`}
        ...
        <div className="content">
          <div className="boxed-text-xl top-25">
            ...
            <p className="text-center ms-3 me-3">
              Install TT Players on your home screen, and access it just like a regular app. Open your Safari menu and tap "Add to Home Screen".
            </p>
            <button 
              onClick={dismiss} 
